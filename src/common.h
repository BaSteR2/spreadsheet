...
public:
    ...
    virtual void SetCell(const Position& pos, const std::string& text) = 0;
    virtual const CellInterface* GetCell(const Position& pos) const = 0;
    virtual CellInterface* GetCell(const Position& pos) = 0;
    virtual void ClearCell(const Position& pos) = 0;
